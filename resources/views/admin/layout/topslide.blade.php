<div class="header-container">
    <header class="header navbar navbar-expand-sm">
        ...
        <div class="nav-logo align-self-center">
            <a class="navbar-brand" href="index.html.htm"><img alt="logo" src="{{ asset('assets/img/header_logo3.jpg') }} "> </a>
        </div>
            ...
            <div class="topbar-nav header navbar" role="banner">
                <nav id="topbar">
                    <ul class="navbar-nav theme-brand flex-row  text-center">
                        <li class="nav-item theme-logo">
                            <a href="index.html.htm">
                                <img src="{{ asset('assets/img/header_logo3.jpg') }}" class="navbar-logo" alt="logo">
                            </a>
                        </li>
                    ...
                    <ul class="list-unstyled menu-categories" id="topAccordion">
                        ...
                        <li class="menu single-menu">
                            <a href="{{ route('admin.customer') }}"  class="dropdown-toggle autodroprown">
                                <div class="">
                                ...
                                <div class="media">
                                    <div class="user-img">
                                        <div class="avatar avatar-xl">
                                            <img src="{{ asset('assets/img/profile-15.jpeg') }}" alt="admin-profile">
                                        </div>
                                    </div>
                        ...
                        <a class="dropdown-item unseen-msg">
                            <div class="">
                                ...
                                <div class="media">
                                    <div class="user-img">
                                        <div class="avatar avatar-xl">
                                            <img src="{{ asset('assets/img/profile-3.jpeg') }}" alt="admin-profile">
                                        </div>
                                    </div>
                                    <div class="media-body">
                                        <div class="">
