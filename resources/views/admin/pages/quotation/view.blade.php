                                            ...
                                            <div class="col-xl-5 invoice-address-client">
                                                ...
                                                <div class="invoice-address-client-fields">
                                                    ...
                                                    <div class="form-group row">
                                                        ...
                                                        <div class="col-sm-9">
                                                            <input type="text" class="form-control form-control-sm"
                                                                id="client_name" name="client-name" value="{{ $user->name }}" disabled>
                                                        </div>
                                                    </div>
                                    ...
                                    <div class="invoice-detail-items" id="invoicedata">
                                        ...
                                        <div class="table-responsive">
                                            <table class="table table-bordered item-table">
                                                ...
                                                <tbody>
                                                    ...
                                                    @foreach ($products as $product)
                                                        @php
                                                            $gtotal = $gtotal + $product->total_amount;
                                                        @endphp
                                                        <tr>
                                                            <input type="hidden" name="product_id[]" id="product_id" value="{{$product->qutationid}}">
                                                            ...
                                                            <td id="discount{{ $product->qutationid }}" class="text-center">{{$product->discount}}%</td>
                                                        </tr>
                                                    @endforeach
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td></td>
                                                        <td></td>
                                                        <td class="w-auto"><p>Total:</p> <p style="width: 101px; margin-bottom: 22px;">Add Discaunt :</p> <p>Grand Total :</p></td>
                                                        <td class="w-auto"><p id="gtotal">{{ $gtotal }}  </p>
                                                        <label for="discauntinput" class="d-flex"><input type="text" name="discauntinput" id="discauntinput" value="" class="form-control form-control-sm" style="width: 148px; height: 34px;">%</label>
                                                        <p id="alldiscount"> </p>
                                                        </td>
                                            ...
                                            <div class="buyernotes d-flex">
                                             <strong>Buyer Recommendation :- </strong> <p>{{$notes}}</p>
                                            </div>
                                        </div>
                                    </div>
                                    <div class="invoice-detail-note">
                                        ...
                                        <div class="row d-flex justify-content-between  mt-4 invoicedashboredbtn">
                                            ...
                                            <div class="">
                                                    ...
                                                    <a href="javascript:void(0);" class="badge badge-dark badge-preview p-2 sendemail" data-id="1" id="priviewinvoice" ><span class="spinner-border spinner-border-sm d-none" role="status" aria-hidden="true"></span> Cancel Recommendation </a>
                                            </div>
                                            <div class="">
                                           
                                               
                                                <a href="javascript:void(0);" class="badge border-0 badge-dark p-2 badge-send sendemail" data-id="2">
