...
@section('content')
                                            ...
                                            <div class="col-xl-5 invoice-address-client">
                                                ...
                                                <div class="invoice-address-client-fields">
                                                    ...
                                                    <div class="form-group row">
                                                        ...
                                                        <div class="col-sm-9">
                                                            <input type="text" class="form-control form-control-sm"
                                                                id="client_name" name="client-name" value="{{ $user->name }}">
                                                        </div>
                                                    </div>
                                    ...
                                    <div class="invoice-detail-note">
                                        ...
                                        <div class="row d-flex justify-content-between  mt-4 invoicedashboredbtn">
                                            ...
                                            <div class="">
                                                ...
                                                <a href="javascript:void(0);" class="badge border-0 badge-primary badge-send sendemail">
        ...
        <div class="modal-dialog" role="document">
            <div class="modal-content">
                ...
                <div class="modal-body">
                    ...
                    <div class="d-flex"><input type="text" class="form-control form-control-sm changeamount"
                            value="1" id="quantity" placeholder="Enter Quantity">
    ...
    {{--  priview quotation --}}
    @include('admin.pages.catalogue.priviewquotation')
@endsection
